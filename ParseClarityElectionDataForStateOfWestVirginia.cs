...
namespace ParseClarityElectionDataForStateOfWestVirginia
{
	...
	class Program
	{
		static string ProjectName = "ParseClarityElectionDataForStateOfWestVirginia";

		static string LocationBeingStudied = "StateOfWestVirginia";

		static string LocationBeingStudiedClearly = "State Of West Virginia";

		static string gitHubRepositoryURL = "https://github.com/IneffablePerformativity/" + ProjectName;

		static string gitHubRepositoryShortened = "https://bit.ly/3of9Q0m";
...
//		static int howOrdering = 8; // 8 is net bonus
		...
		const string contestPotus = "PRESIDENT";

		
		// zero, one, or two
		const string contestSenus1 = "U.S. SENATOR";
		...
		const string contestRepus1 = "U.S. HOUSE OF REPRESENTATIVES, 1st Congressional District";
		const string contestRepus2 = "U.S. HOUSE OF REPRESENTATIVES, 2nd Congressional District";
		const string contestRepus3 = "U.S. HOUSE OF REPRESENTATIVES, 3rd Congressional District";
